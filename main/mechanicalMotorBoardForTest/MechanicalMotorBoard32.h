#ifndef MECHANICAL_MOTOR_BOARD_H
#define MECHANICAL_MOTOR_BOARD_H

#include "../../common/io/buffer.h"

#define MECHANICAL_MOTOR_BOARD_PIC_NAME "MOTOR BOARD 32"
...
#define MOTOR_BOARD_SERIAL_PORT_STANDARD    SERIAL_PORT_5
